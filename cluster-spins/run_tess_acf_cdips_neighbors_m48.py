...
def get_lc_and_period(n,mems,size=(31,31),sigma_thresh=5,tpfplot=False,sec=0):
    ...
    lcdirs = glob.glob('/Users/bhealy/Documents/PhD_Thesis/Phase_3/M48_CDIPS/mastDownload/HLSP/*'+np.str(gaia_ids[n])+'*')
...
perTbl = ascii.read('/Users/bhealy/Documents/PhD_Thesis/Phase_3/M48_periods/cdips_lcgen/M48_ptbl_cdips_neighbors.dat')
...
#ssl.SSLError
    ...
    lctbl.write('/Users/bhealy/Documents/PhD_Thesis/Phase_3/M48_periods/cdips_lcgen/Figs/Light_Curves/'+np.str(n)+'_'+gaia_id+'_lc.txt',format='ascii',overwrite=True)

    pdgtbl = pdg.to_table()
    pdgtbl.write('/Users/bhealy/Documents/PhD_Thesis/Phase_3/M48_periods/cdips_lcgen/Figs/Periodograms/'+np.str(n)+'_'+gaia_id+'_pdg.txt',format='ascii',overwrite=True)
    ...
    fig2.savefig('/Users/bhealy/Documents/PhD_Thesis/Phase_3/M48_periods/cdips_lcgen/CDIPS_LC_DVRs_neighbors/'+np.str(n)+'_'+gaia_id+'_dvr.pdf',overwrite=True,bbox_inches='tight')
    plt.close('all')
    ...
    if -1 not in closeids[n]:
       ...
       for m in range(len(closeids[n])):
           ...
           #print(n,m)
           lcdirs = glob.glob('/Users/bhealy/Documents/PhD_Thesis/Phase_3/M48_CDIPS/mastDownload/HLSP/*'+np.str(closeids[n][m])+'*')
           ...
           lctbl.write('/Users/bhealy/Documents/PhD_Thesis/Phase_3/M48_periods/cdips_lcgen/Figs/Neighbor_Light_Curves/'+np.str(n)+'_'+gaia_id+'_lc.txt',format='ascii',overwrite=True)

           pdgtbl = pdg.to_table()
           pdgtbl.write('/Users/bhealy/Documents/PhD_Thesis/Phase_3/M48_periods/cdips_lcgen/Figs/Neighbor_Periodograms/'+np.str(n)+'_'+gaia_id+'_pdg.txt',format='ascii',overwrite=True)
    ...
    fig3.savefig('/Users/bhealy/Documents/PhD_Thesis/Phase_3/M48_periods/cdips_lcgen/CDIPS_LC_DVRs_neighbors/'+np.str(n)+'_'+gaia_id+'_neighbors.pdf',overwrite=True,bbox_inches='tight')
    ...
    perTbl.write('/Users/bhealy/Documents/PhD_Thesis/Phase_3/M48_periods/cdips_lcgen/M48_ptbl_cdips_neighbors.dat',format='ascii',overwrite=True)
