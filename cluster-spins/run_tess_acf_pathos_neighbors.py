...
perTbl = ascii.read('/Users/bhealy/Documents/PhD_Thesis/NGC_2516/pathos_lcgen/NGC_2516_ptbl_pathos_neighbors.dat')
...
#for n in range(300,len(ngc2516mems)):
...
#ssl.SSLError
    ...
    bprp = np.str(np.round(ngc2516mems['bp_rp'][n],2))
    print(n, gaia_id)
    #toi = toi_unique[n]
    ...
    lctbl.write('/Users/bhealy/Documents/PhD_Thesis/NGC_2516/pathos_lcgen/Figs/Light_Curves/'+np.str(n)+'_'+gaia_id+'_lc.txt',format='ascii',overwrite=True)

    pdgtbl = pdg.to_table()
    pdgtbl.write('/Users/bhealy/Documents/PhD_Thesis/NGC_2516/pathos_lcgen/Figs/Periodograms/'+np.str(n)+'_'+gaia_id+'_pdg.txt',format='ascii',overwrite=True)
    ...
    fig2.savefig('/Users/bhealy/Documents/PhD_Thesis/NGC_2516/pathos_lcgen/PATHOS_LC_DVRs_neighbors/'+np.str(n)+'_'+gaia_id+'_dvr.pdf',overwrite=True,bbox_inches='tight')
    plt.close('all')
    ...
    if -1 not in closeids[n]:
       ...
       for m in range(len(closeids[n])):
           ...
           lctbl.write('/Users/bhealy/Documents/PhD_Thesis/NGC_2516/pathos_lcgen/Figs/Neighbor_Light_Curves/'+np.str(n)+'_'+gaia_id+'_lc.txt',format='ascii',overwrite=True)

           pdgtbl = pdg.to_table()
           pdgtbl.write('/Users/bhealy/Documents/PhD_Thesis/NGC_2516/pathos_lcgen/Figs/Neighbor_Periodograms/'+np.str(n)+'_'+gaia_id+'_pdg.txt',format='ascii',overwrite=True)
    ...
    fig3.savefig('/Users/bhealy/Documents/PhD_Thesis/NGC_2516/pathos_lcgen/PATHOS_LC_DVRs_neighbors/'+np.str(n)+'_'+gaia_id+'_neighbors.pdf',overwrite=True,bbox_inches='tight')
    ...
    perTbl.write('/Users/bhealy/Documents/PhD_Thesis/NGC_2516/pathos_lcgen/NGC_2516_ptbl_pathos_neighbors.dat',format='ascii',overwrite=True)
